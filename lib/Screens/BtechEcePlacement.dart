...
class BtechEcePlacement extends StatefulWidget {
  const BtechEcePlacement({Key? key}) : super(key: key);

  @override
  State<BtechEcePlacement> createState() => _BtechEcePlacementState();
}

class _BtechEcePlacementState extends State<BtechEcePlacement> {
  final auth = FirebaseAuth.instance;
  final firestore = FirebaseFirestore.instance
      .collection('UIET PLACEMENT')
      .doc('BTECH')
      .collection('ECE').orderBy('Package')
      .snapshots();
  @override
        ...
        child: Scaffold(
          ...
          body: Column(
            children: [
              ...
              Text("ECE PLACEMENTS",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w600),),
              SizedBox(height: 20,),
              Container(
                height:1,
