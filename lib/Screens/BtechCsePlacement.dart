...
class BtechCsePlacement extends StatefulWidget {
  const BtechCsePlacement({Key? key}) : super(key: key);

  @override
  State<BtechCsePlacement> createState() => _BtechCsePlacementState();
}

class _BtechCsePlacementState extends State<BtechCsePlacement> {
  final auth = FirebaseAuth.instance;
  final firestore = FirebaseFirestore.instance
      .collection('UIET PLACEMENT')
      .doc('BTECH')
      .collection('CSE').orderBy('Package',descending: false)
      .snapshots();
  @override
    ...
    return SafeArea(
      ...
      body: Column(
        children: [
          ...
          Text("CSE PLACEMENTS",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w600),),
          SizedBox(height: 20,),
          Container(
            height:1,
