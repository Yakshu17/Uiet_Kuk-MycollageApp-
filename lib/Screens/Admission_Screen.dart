...
//----------------------------------------Create Btech Dept Table ---------------------------------------------------
                        ...
                        Container(
                          ...
                          child: const Text(
                              "Here you can check the vacant seats update for UIET B.Tech courses for"
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                        snapshot.data!.docs[index]['CSE Seats'].toString(),
                                        style: TextStyle(
                                          fontSize: 15,
                                        ),
                                      )),
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child:  Center(
                                      child: Text(
                                        snapshot.data!.docs[index]['ECE Seats'].toString(),
                                        style: TextStyle(
                                          fontSize: 15,
                                        ),
                                      )),
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child:  Center(
                                      child: Text(
                                        snapshot.data!.docs[index]['ME Seats'].toString(),
                                        style: TextStyle(
                                          fontSize: 15,
                                        ),
                                      )),
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child:  Center(
                                      child: Text(
                                        snapshot.data!.docs[index]['BT Seats'].toString(),
                                        style: TextStyle(
                                          fontSize: 15,
                                        ),
                                      )),
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child:  Center(
                                      child: Text(
                                        snapshot.data!.docs[index]['CSE AIML Seats'].toString(),
                                        style: TextStyle(
                                          fontSize: 15,
                                        ),
                                      )),
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child:  Center(
                                      child: Text(
                                        snapshot.data!.docs[index]['EE Seats'].toString(),
                                        style: TextStyle(
                                          fontSize: 15,
                                        ),
                                      )),
                        ...
                        Container(
                          width: screen.width * 0.9,
                          child: const Text(
                              "The admissions to B.Tech. programmes in first year shall be made on through following mode-"),
                        ),
                        const SizedBox(
                          height: 25,
                        ),
                        ...
                        Container(
                          width: screen.width * 0.9,
                          child: const Text(
                              "The admissions to B.Tech. programmes in first year shall be made on through JEE Mains."),
                        ),
                        const SizedBox(
                          height: 12,
                        ),
                        Container(
                          width: screen.width * 0.9,
                          child: const Text(
                              "• 100% seats of total intake shall be filled on the basis of merit rank obtained by the "
                        ...
                        Container(
                          width: screen.width * 0.9,
                          child: const Text(
                              "The admissions to B.Tech. 2nd Year (Lateral Entry) shall be made on through Online Entrance Test conducted by HSTES and for more infomation visit HSTES Website"),
                        ),
                        TextButton(
                            onPressed: () {
                        ...
                        Container(
                          ...
                          child: const Text(
                              "The candidate should have passed 10+2 examination with at least 55% marks "
                        ...
                        Container(
                          width: screen.width * 0.9,
                          child: const Text(
                              "The candidate should have passed three/two years Diploma examination from an"
                        ...
                        Container(
                          ...
                          child: const Text(
                            "*  In Leet 85% Seats are Reserved for Harayana ",
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                        ),
                        const SizedBox(
                        ...
                        Container(
                          width: screen.width * 0.85,
                          child: const Text(
                            "* 15% Seats for Other State Students ",
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                        ),
                        const SizedBox(
                        ...
                        Container(
                          ...
                          child: const Text(
                              "The candidate should have passed three year B.Sc. degree from any recognized University of India"
